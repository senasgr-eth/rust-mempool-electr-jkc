...
impl Network {
    ...
    pub fn from_magic(magic: u32) -> Option<Network> {
        ...
        match magic {
            0xfbc0b6db => Some(Network::Bitcoin),  // Junkcoin mainnet
            0xfcc1b7dc => Some(Network::Testnet),  // Junkcoin testnet
            0xfcc1b7dc => Some(Network::Signet),   // Junkcoin signet (same as testnet)
            0xfcc1b7dc => Some(Network::Regtest),  // Junkcoin regtest (same as testnet)
            _ => None
        }
    }
    ...
    ///
    /// let network = Network::Bitcoin;
    /// assert_eq!(network.magic(), 0xfbc0b6db);
    /// ```
    pub fn magic(self) -> u32 {
        // Note: any new entries here must be added to `from_magic` above
        match self {
            Network::Bitcoin => 0xfbc0b6db,  // Junkcoin mainnet
            Network::Testnet => 0xfcc1b7dc,  // Junkcoin testnet
            Network::Signet  => 0xfcc1b7dc,  // Junkcoin signet (same as testnet)
            Network::Regtest => 0xfcc1b7dc,  // Junkcoin regtest (same as testnet)
        }
    }
}
